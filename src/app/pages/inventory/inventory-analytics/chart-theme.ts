// Shared Chart.js styling so all six charts on the page read as one system.
// Colors depend on the active app theme (light/dark) so charts stay legible
// whichever the user has selected — pass the current isDark flag through.
